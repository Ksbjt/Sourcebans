						...
						<li class="nav-item dropdown">
							...
							<div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="notificationDropdown">
								...
								<form method="get" action="index.php" id="commform">
									...
									<a class="dropdown-item">
										<p class="mb-0 font-weight-normal float-left">搜索通讯封禁...
										</p>
									</a>
									<a class="dropdown-item preview-item">
			...
			<div class="nav-link">
				...
				<div class="user-wrapper">
					...
					<div class="text-wrapper">
						...
						<div class="mt-2">
							<small class="designation text-muted"><a href='index.php?p=logout'>登出</a></small>
						</div>
					</div>
				</div>
				{else}
				<button onclick="location.href='index.php?p=login';" class="btn btn-success btn-block">登录
				</button>
				{/if}
			</div>
		</li>