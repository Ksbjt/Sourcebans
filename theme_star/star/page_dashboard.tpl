				...
				<div class="card-statistics">
					<div class="card-body">
						<div class="clearfix">
							...
							<p class="mb-0 text-right" data-aos="flip-left" data-aos-delay="300">所有服务器</p>
				...
				<div class="card-statistics">
					<div class="card-body">
						<div class="clearfix">
							...
							<p class="mb-0 text-right" data-aos="flip-left" data-aos-delay="500">所有封禁</p>
							<div class="fluid-container">
				...
				<div class="card-statistics">
					<div class="card-body">
						<div class="clearfix">
							...
							<p class="mb-0 text-right" data-aos="flip-left" data-aos-delay="700">所有屏蔽封禁</p>
							<div class="fluid-container">
				...
				<div class="card-statistics">
					<div class="card-body">
						<div class="clearfix">
							...
							<p class="mb-0 text-right" data-aos="flip-left" data-aos-delay="900">所有阻断连接数</p>
							<div class="fluid-container">
...
<div class="row">
	<div class="col-lg-12 grid-margin" data-aos="fade-out"  data-aos-delay="150">
		<div class="card">
			<div class="card-body">
				<h4 class="card-title" style="margin-bottom:0px;">最新添加的封禁</h4>
				<p class="card-description">
					<code>所有封禁:{$total_bans}</code>
				</p>
...
<div class="row">
	<div class="col-lg-6 grid-margin" data-aos="fade-out" data-aos-delay="250">
		<div class="card">
			<div class="card-body">
				<h4 class="card-title" style="margin-bottom:0px;">最新的屏蔽封禁</h4>
				<p class="card-description">
					<code>所有屏蔽封禁: {$total_comms}</code>
				</p>
				<div class="table-responsive">
					<table class="table table-bordered table-striped table-hover tbl-sm">
						<thead>
	...
	<div class="col-lg-6 grid-margin" data-aos="fade-out" id="test" data-aos-delay="550">
		<div class="card">
			<div class="card-body">
				<h4 class="card-title" style="margin-bottom:0px;">最近屏蔽的玩家</h4>
				<p class="card-description">
					<code>总阻断数: {$total_blocked}</code>
				</p>
				<div class="table-responsive">
					<table class="table table-bordered table-striped table-hover tbl-sm">
						<thead>
						...
						<tbody>
							...
							<tr{if $dashboard_lognopopup} onclick="{$player.link_url}"{else} onclick="{$player.popup}" {/if} style="cursor: pointer;" id="{$player.server}" title="请求服务器数据..." data-aos="zoom-in">
							<td>
